...
export class DashboardComponent implements OnInit {
  ...
  navigateToAddCycle(){
    this.router.navigate(['addCycle']);
  }
  navToAffectFormateur(){
    this.router.navigate(['affectFormateur']);

  }
  navToDelFormateur(){
    this.router.navigate(['delFormateur']);

  }
  navToAffectParticipant(){
    this.router.navigate(['affectParticipant']);

  }
  navToDelParticipant(){
    this.router.navigate(['delParticipant']);
